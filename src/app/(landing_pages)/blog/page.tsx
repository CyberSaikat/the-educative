...
const BlogPage = async () => {
  ...
  return (
    <div className="container py-5">
      <div className="relative bg-gradient-to-br from-teal-400 to-cyan-500 text-white overflow-hidden rounded-t-xl">
            ...
            <div className="hidden sm:block lg:w-1/2 mt-8 lg:mt-0">
              <div className="relative rounded-lg overflow-hidden shadow-2xl">
                <LazyImage
                  ...
                  height={400}
                  layout="responsive"
                  className="relative rounded-lg shadow-2xl transform hover:scale-110 origin-top-left transition-transform duration-500 object-cover"
                />
              </div>
            </div>
          </div>
